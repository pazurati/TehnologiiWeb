...
class Register extends Component{
    ...
    render(){
        ...
        if(!this.props.isRegistered){
            ...
            return(
           <div style={{height:"100vh", backgroundColor:"#FFF6EB"}}>
            <div>     
                <div style={{height:"30px"}}></div>
                <Container id="registerConainer" style={{ float:"center",  backgroundColor:"#FFE4C4", width:300, height:300, borderRadius:"25px"}}>
